...
|File|Purpose|
|--|--|
|[`CLAUDE.md`](CLAUDE.md)|Assistant skill with core HyperLiquid.Net patterns, pitfalls, and examples|
...
* Version 3.5.0 - 22 Jan 2026
    ...
    * Added Metadata to HyerLiquidExchange
...
* Version 3.4.0 - 13 Jan 2026
    ...
    * Added restClient.SpotApi.Account.GetExtraAgentsAsync endpoint

* Version 3.3.0 - 08 Jan 2026
    * Added restClient.FuturesApi.Account.GetHip3DexAbstractionAsync endpoint
...
* Version 3.2.0 - 07 Jan 2026
    ...
    * Added SubscribeToBookTickerUpdatesAsync subscription
    * Fixed EditOrdersAsync not allowing editing of trigger orders
    * Fixed SubscribeToOrderBookUpdatesAsync when specifying nSigFigs

* Version 3.1.0 - 24 Dec 2025
    * Updated CryptoExchange.Net version to 10.0.2, see https://github.com/JKorf/CryptoExchange.Net/releases/ for release notes
    * Added SendAssetAsync endpoint to REST account clients
...
* Version 3.0.0 - 16 Dec 2025
    ...
    * Fixed Spot USDH, USDT and USDE symbols not getting properly mapped to their id
...
* Version 2.17.0 - 11 Nov 2025
    ...
    * Fixed Shared Trades update not getting marked as snapshot
