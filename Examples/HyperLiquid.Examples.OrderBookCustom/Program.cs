...
collection.AddHyperLiquid();
var provider = collection.BuildServiceProvider();

Action<HyperLiquidOrderBookOptions> optionsDelegate = options =>
{
    options.NSigFigs = 3; 
};
...
var book = bookFactory.Create(new SharedSymbol(TradingMode.Spot, "BTC", "USDC"), optionsDelegate);
